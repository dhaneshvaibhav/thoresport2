...
{ /* Teams and Tournaments Section */}
  ...
  <button
    ...
    onMouseOver={e => {
      ...
      e.currentTarget.style.boxShadow = '0 0 24px #01E2E9';
      e.currentTarget.style.background = 'linear-gradient(90deg, #01E2E9 80%, #BABC19 100%)';
    }}
    onMouseOut={e => {
      e.currentTarget.style.transform = 'none';
      e.currentTarget.style.boxShadow = '0 0 8px #01E2E955';
      e.currentTarget.style.background = 'linear-gradient(90deg, #01E2E9 60%, #1976d2 100%)';
    }}
    onClick={() => {
...
function getResponsiveStyles() {
  ...
  return {
    ...
    heroContent: {
      ...
      padding: isMobile ? '1.2rem 0.2rem' : '0',
